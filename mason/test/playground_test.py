...
class TestCLI:
    ...
    def test_play(self):
        ...
        print_result(runner.invoke(run, ["operator", "table", "summarize", "-p", f"database_name:mason-test-data,table_name:/csv/test.csv,read_headers:true", "-l", "trace"], catch_exceptions=False))
