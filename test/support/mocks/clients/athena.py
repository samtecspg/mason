...
class AthenaMock:
    ...
    def start_query_execution(*args, **kwargs):
        ...
        elif (kwargs["QueryExecutionContext"]["Database"] == "good_database") and (kwargs["QueryString"] == "SELECT * from good_table;") and kwargs["WorkGroup"] == "mason":
    ...
    def get_query_results(*args, **kwargs):
        if kwargs["QueryExecutionId"] == "good_id":
            return {
                'UpdateCount': 0,
                'ResultSet':
        ...
        elif kwargs["QueryExecutionId"] == "bad_id":
            return {'Errors': ['Query did not finish successfully. Final query state: FAILED'], 'Info': [], 'Warnings': []}
